...
public function inserir ($servername,$username,$password,$data_estreno,$durada,$titol)
{
    ...
    try {
      ...
      try
      {
        $sql = "INSERT INTO pelicula (titol,data_estreno,durada) VALUES ('$data_estreno',$durada,'$titol')";
...
function modificar ($servername, $username, $password,$id,$data_estreno,$durada,$titol)
{
  $conn = $this->connectar_bd($servername,$username,$password);
  try {
  
    $sql = "UPDATE pelicula SET titol='$titol',
    data_estreno='$data_estreno', durada='$durada',
    WHERE id='$id'";
